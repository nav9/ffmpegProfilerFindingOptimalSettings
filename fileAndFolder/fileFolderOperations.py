...
class FileOperations:
    ...
    def getNamesOfVideoFilesToProcess(self, folderPath, supportedFormats):
        videoNamesWithPath = []
        if self.isThisValidDirectory(folderPath):
            filenames = self.getListOfFilesInThisFolder(folderPath)
